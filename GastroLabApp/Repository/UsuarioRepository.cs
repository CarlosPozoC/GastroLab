...
namespace GastroLabApp.Repository
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public ICollection<Opinion> GetOpinionesByUsuario(int UsuarioId)
        {
            return context.Opiniones.Where(re => re.usuario.Id == UsuarioId).ToList();
        }

        public ICollection<Receta> GetRecetasByUsuario(int UsuarioId)
        {
            return context.Recetas.Where(re => re.Usuario.Id == UsuarioId).ToList();
        }
    }
}
